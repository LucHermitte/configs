...
if s:currently_edited_file !~ 'OssimPlugins'
  LetTo p:&cinoptions={1s,:0,l1,g0,c0,(0,(s,m1 " ITK/VTK style indenting
  " ))} <-  used to trick syntax highlight
  LetTo p:&sw=2
else
  " Usual indent options
  LetTo p:&cinoptions=g0,t0,h1s,i0
  LetTo p:&sw=3
endif
LetTo p:&matchpairs+=<:>
...
LetIfUndef p:dox_ingroup            = '1'
LetIfUndef p:dox_brief              = '1'
